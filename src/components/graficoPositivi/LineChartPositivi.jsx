...
export default class BarChartPositivi extends React.Component {
  constructor(props) {
    super(props);
      ...
      return (
        <Line
          ...
          options={{
            ...
            title: {
              display: true,
              text: "Totale positivi negli ultimi 30 giorni",
            },
            tooltips: {
              callbacks: {
      ...
      return (
        <Line
          ...
          options={{ 
            ...
            title: {
              display: true,
              text: "Totale positivi da inizio pandemia (24/02/2020) ad oggi",
            },
          }}
        />
      );
